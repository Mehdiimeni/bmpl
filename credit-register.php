 ...
 <body>
  ...
  <div class="container flex-grow-1 d-flex align-items-center justify-content-center">
   <div class="login-card">
    <h6 class="text-center mb-4">برای دریافت اعتبار **کد ملی** خود را وارد کنید. کد ملی و شماره همراه باید برای یک نفر
     باشد.</h6>
    <form id="nationalCodeForm">
     <div class="input-field">
      <label for="nationalCode">کد ملی</label>
      <input type="text" id="nationalCode" class="form-control" maxlength="10" placeholder="مثلاً 1234567890" required
       inputmode="numeric" pattern="[0-9]*" aria-label="کد ملی">
