   ...
   integrity="sha384-MdqCcafa5BLgxBDJ3d/4D292geNL64JyRtSGjEszRUQX9rhL1QkcnId+OT7Yw+D+" crossorigin="anonymous">
    ...
    <style>
        ...
        .credit-card {
            ...
            transform: translateY(-30px); /* Lift card slightly for visual appeal */
            transition: transform 0.3s ease-out;
        }
        
        .credit-card:hover {
            transform: translateY(-35px); /* Slightly more lift on hover */
        }


        .credit-amount {
            font-size: 2.2rem; /* Larger font for amount */
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 5px 15px rgba(91, 134, 229, 0.3); /* Adjust shadow color */
        }
        ...
        .tf-navigation-bar li a.active {
            ...
            background-color: rgba(91, 134, 229, 0.08); /* Adjusted active background color */
            font-weight: 700;
        }
        ...
        .tf-navigation-bar li a:hover {
            color: var(--primary-color);
            background-color: rgba(91, 134, 229, 0.05); /* Adjusted hover background color */
        }
    ...
    <div class="container flex-grow-1 d-flex flex-column justify-content-center align-items-center">
        <div class="credit-card">
            ...
            <div class="d-flex justify-content-between mt-4 gap-3">
                <a href="#" class="btn btn-primary flex-grow-1" aria-label="خرید کالا">خرید کالا</a>
                <a href="#" class="btn btn-outline-secondary flex-grow-1" aria-label="خرید خدمات">خرید خدمات</a>
            </div>
        </div>
                    ...
                    <a href="credit-details.php" class="text-decoration-none" aria-label="افزایش اعتبار">
                        <div class="card-body">
                            <div class="feature-icon">
                                <i class="fas fa-arrow-up-right-dots"></i> </div>
