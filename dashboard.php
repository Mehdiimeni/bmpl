...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="credit-offer text-center">
                        <a style="text-decoration:none" href="credit-enter.php" aria-label="خدمات اعتباری">
                            <div class="btn btn-credit d-flex flex-column flex-md-row justify-content-center">
                                خدمات
                                اعتباری
                            </div>
                        </a>
    ...
    <div class="mt-5 mb-5">
        <div class="container">
            ...
            <div class="mt-3">
                <div class="swiper recipient-tes">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 1">
                                <img src="./images/shop (1).jpg" alt="images">
                                فروشگاه 1
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 2">
                                <img src="./images/shop (1)11.jpg" alt="images">
                                فروشگاه 2
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 3">
                                <img src="./images/shop (144).jpg" alt="images">
                                فروشگاه 3
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 4">
                                <img src="./images/shop (2).jpg" alt="images">
                                فروشگاه 4
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 5">
                                <img src="./images/shop (69872).jpg" alt="images">
                                فروشگاه 5
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 6">
                                <img src="./images/shop (2222).jpg" alt="images">
                                فروشگاه 6
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 7">
                                <img src="./images/shop (2df).jpg" alt="images">
                                فروشگاه 7
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 8">
                                <img src="./images/shop (3).jpg" alt="images">
                                فروشگاه 8
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 9">
                                <img src="./images/shop (3).png" alt="images">
                                فروشگاه 9
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 10">
                                <img src="./images/shop (3777).jpg" alt="images">
                                فروشگاه 10
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 11">
                                <img src="./images/shop (44441).jpg" alt="images">
                                فروشگاه 11
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 12">
                                <img src="./images/shop (4543).jpg" alt="images">
                                فروشگاه 12
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a class="recipient-box" href="#" aria-label="فروشگاه 13">
