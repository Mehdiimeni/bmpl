  ...
  <div class="points-container">
    <div class="points-card">
      ...
      <div class="points-info">
        ...
        <span class="value">۴٬۵۰۰ امتیاز</span>
      </div>

      <div class="points-info">
        <label>امتیاز کسب‌شده از خرید:</label>
        <span class="value">۱٬۲۰۰ امتیاز</span>
      </div>

      <div class="points-info">
        <label>امتیاز کسب‌شده از پرداخت اقساط:</label>
        <span class="value">۸۰۰ امتیاز</span>
      </div>

      <div class="points-info">
        <label>امتیاز کسب‌شده از افزودن اعتبار:</label>
        <span class="value">۱٬۰۰۰ امتیاز</span>
      </div>
    </div>

    <div class="points-list">
      <h4>لیست امتیازهای کسب‌شده</h4>
      <table>
        <thead>
          <tr>
            <th>عنوان</th>
